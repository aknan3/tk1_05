...
public class Hangar extends Thread {
    ...
    public void sendMarkerMessageToSecond() {
        ...
        try {
            ...
            MainWindow.getHistoryListModel().addElement("Mark: " + markerMessage.getSender() + " -> " + markerMessage.getReceiver());
        } catch (IOException e) {
    ...
    private void sendAirplanes() {
        ...
        try {
            ...
            if (sentToHangar == 0) {
                ...
                MainWindow.getHistoryListModel().addElement("Transfer: " + this.hangarName + " -> " + receivingHangarName + " " + "(" + numSentAirplanes + ")");
            } else {
                if (this.hangarName == "H3")
                    receivingHangarName = "H2";
                else
                ...
                applicationMessage.setReceiver(receivingHangarName);
                MainWindow.getHistoryListModel().addElement("Transfer: " + this.hangarName + " -> " + receivingHangarName + " " + "(" + numSentAirplanes + ")");
              //  MainWindow.historyListModel.addElement("Transfer: " + this.hangarName + " -> " + receivingHangarName + " " + "(" + numSentAirplanes + ")");
