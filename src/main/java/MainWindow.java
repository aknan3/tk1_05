...
public class MainWindow extends JFrame {
	...
	static DefaultListModel<String> getHistoryListModel() {
		return historyListModel;
	}

	public void setHistoryListModel(DefaultListModel<String> historyListModel) {
	...
	private void snapshot(int initiatorHangarIndex, Hangar hangar1, Hangar hangar2, Hangar hangar3) {
		// TODO
		historyListModel.addElement("Snapshot: " + initiatorHangarIndex + " Initiator");
		...
		//historyListModel.addElement(">> Mark: " + snapshotInitiatorHanger.getHangarName() + " -> " + hangar2.getHangarName());
		snapshotInitiatorHanger.sendMarkerMessageToThird();
		//historyListModel.addElement(">> Mark: " + snapshotInitiatorHanger.getHangarName() + " -> " + hangar3.getHangarName());
		...
		historyListModel.addElement(">> Captured global state <<");
		historyListModel.addElement(" Local State = H1: " + hangar1.getLocalState());
		historyListModel.addElement(" Local State = H2: " + hangar2.getLocalState());
		historyListModel.addElement(" Local State = H3: " + hangar3.getLocalState());
		
		historyListModel.addElement(">> Channel 2 -> 1: " + hangar1.getFirstRecordedIncommingChannel());
		historyListModel.addElement(">> Channel 3 -> 1: " + hangar1.getSecondRecordedIncommingChannel());
		historyListModel.addElement(">> Channel 1 -> 2: " + hangar2.getFirstRecordedIncommingChannel());
		historyListModel.addElement(">> Channel 3 -> 2: " + hangar2.getSecondRecordedIncommingChannel());
		historyListModel.addElement(">> Channel 1 -> 3: " + hangar3.getFirstRecordedIncommingChannel());
		historyListModel.addElement(">> Channel 2 -> 3: " + hangar3.getSecondRecordedIncommingChannel());
		historyListModel.addElement(" Global State = H1: " + "(" + hangar1.getLocalState() + ", " 
																 + hangar1.getFirstRecordedIncommingChannel() + ", "
																 + hangar1.getSecondRecordedIncommingChannel()
																 + ")");
		historyListModel.addElement(" Global State = H2: " + "(" + hangar2.getLocalState() + ", " 
																 + hangar2.getFirstRecordedIncommingChannel() + "   "
																 + hangar2.getSecondRecordedIncommingChannel()
																 + ")");
		historyListModel.addElement(" Global State = H3: " + "(" + hangar3.getLocalState() + ", " 
																 + hangar3.getFirstRecordedIncommingChannel() + ", "
																 + hangar3.getSecondRecordedIncommingChannel()
																 + ")");
		...
		printRecordedChannel(">> Channel 2 -> 3: ", hangar3.getSecondRecordedIncommingChannel());
		System.out.println();
